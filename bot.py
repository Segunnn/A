...
class ButtonView(dick.ui.View):
    def __init__(self):
        super().__init__()
    @dick.ui.button(label="Reroll", style=dick.ButtonStyle.gray, emoji='▫️') #It's reroll button create :)
    async def function_name(self, i: dick.Interaction, button: dick.ui.Button):
...
@slave.command()
async def fuf(ctx, time_to_wait: int, *, prize: str):
